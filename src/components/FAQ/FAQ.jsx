...
const FAQ = () => {
    ...
    return (
        <>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', backgroundColor: 'blue', top: 0, height: matchDownMd ? '22vh' : '35vh', paddingLeft: '30%', paddingTop: matchDownMd ? '300px' : '400px', paddingRight: '30%', paddingBottom: matchDownMd ? '30px' : '70px', justifyContent: 'end' }}>
            ...
            <Grid container style={{ height: '100%', backgroundColor: 'white' }}>
                ...
                <Grid item xs={12} sm={12} md={12} lg={12} xl={12} sx={{ padding: '5% 25% 5% 25%' }} >
                    ...
                    <Box sx={{ minHeight: 180, flexGrow: 1, maxWidth: '100%' }}>
                        ...
                        >
                           ...
                           label={<Typography sx={{color:'blue',fontSize:'1.5rem',fontWeight:'bold',':hover':{
